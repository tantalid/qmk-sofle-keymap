...
[_LOWER] = LAYOUT(
  ...
  KC_SPC,  S(KC_LBRC),      S(KC_9),        S(KC_0),        S(KC_RBRC),   KC_DEL,                             KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_SCLN, KC_QUOT,
...
[_RAISE] = LAYOUT(
  KC_F1,    KC_F2,   KC_F3,     KC_F4,   KC_F5,     KC_F6,                            KC_F7,        KC_F8,          KC_F9,          KC_F10,     KC_F11,         KC_F12,
  _______, _______,  _______,   _______, _______,  _______,                           KC_HOME,      KC_PGDN,        KC_PGUP,        KC_END,     RM_VALU,        UA_GE,
  _______, _______,  _______,   KC_MPLY, KC_VOLD,  KC_VOLU,                           KC_LEFT,      KC_DOWN,        KC_UP,          KC_RGHT,    RM_VALD,        UA_YO,
